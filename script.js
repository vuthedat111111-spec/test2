...
const LandingPage = ({ srsData, onOpenReviewList, onOpenSetup, dbData }) => {
    ...
    const notifications = [
        { 
            id: 3, 
            title: 'Tiêu đề thông báo mới', 
            date: '08/03/2026', 
            content: 'Nội dung chi tiết thông báo mới của bạn...'
        }
    ];
    ...
    // KHÓA NỀN TUYỆT ĐỐI CHO TẤT CẢ MODAL
    useEffect(() => {
        if (isDocsModalOpen) {
            document.body.style.overflow = 'hidden';
            document.body.style.touchAction = 'none'; // Chống trượt trên iPhone
        } else {
            document.body.style.overflow = 'unset';
    ...
    return (
        <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-zinc-900 selection:text-white relative">
            ...
            {/* NAVBAR TỐI ƯU DI ĐỘNG */}
            <nav className="fixed top-0 left-0 right-0 z-40 bg-white/80 backdrop-blur-md border-b border-zinc-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        {/* Logo */}
                        <a href="https://www.tiktok.com/@phadaotiengnhat" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 cursor-pointer group">
                            ...
                            <span className="text-lg font-bold tracking-tight text-zinc-900">PHÁ ĐẢO<span className="font-light"> TIẾNG NHẬT</span></span>
                        </a>
                        
                        <div className="flex items-center gap-2">
                            {/* Menu PC: Tài liệu (Ẩn trên mobile) */}
                            <button onClick={() => setIsDocsModalOpen(true)} className="hidden md:block text-sm font-bold text-zinc-600 hover:text-zinc-900 px-2 py-1 rounded-lg hover:bg-zinc-50">
                                Tài liệu
                            </button>

                            {/* CHUÔNG THÔNG BÁO: HIỆN CẢ PC LẪN MOBILE TẠI ĐÂY */}
                            <div className="relative flex items-center" ref={notifRef}>
                                <button onClick={handleToggleNotif} className="relative p-2 text-zinc-500 hover:text-zinc-900 transition-colors rounded-full hover:bg-zinc-100">
                                ...
                                {isNotifOpen && (
                                    <div className="absolute top-full right-0 mt-3 w-[85vw] sm:w-80 bg-white border border-zinc-200 rounded-2xl shadow-2xl z-50 animate-in fade-in zoom-in-95 duration-200 origin-top-right">
                                        <div className="px-4 py-3 border-b border-zinc-100 bg-zinc-50"><span className="font-black text-sm text-zinc-800 uppercase tracking-wide">Thông báo</span></div>
                                        <div className="max-h-[350px] overflow-y-auto custom-scrollbar p-1.5 space-y-1">
                                            {notifications.length > 0 ? (
                                                notifications.map(notif => {
                                                    ...
                                                    return (
                                                        <div key={notif.id} className={`p-3 rounded-xl transition-colors ${isNew ? 'bg-blue-50/50' : 'hover:bg-zinc-50'}`}>
                                                            <div className="flex gap-3">
                                                                <div className="mt-1">{isNew ? <div className="w-2 h-2 rounded-full bg-blue-600"></div> : <div className="w-2 h-2 rounded-full bg-zinc-300"></div>}</div>
                                                                <div className="flex-1">
                                                                    <h4 className={`text-sm mb-0.5 ${isNew ? 'font-bold' : 'font-semibold'}`}>{notif.title}</h4>
                                                                    <p className="text-[10px] text-zinc-400 mb-1">{notif.date}</p>
                                                ...
                                                <div className="py-10 text-center flex flex-col items-center">
                                                    <div className="w-10 h-10 bg-zinc-50 rounded-full flex items-center justify-center mb-2 text-zinc-300"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10.26 3.27A6.6 6.6 0 0 1 12 3a6 6 0 0 1 6 6v7h4l-3.21 3.21A2 2 0 0 1 17 21H7a2 2 0 0 1-1.93-1.46"/><path d="m2 2 20 20"/></svg></div>
                                                    <span className="text-xs font-bold text-zinc-400">Chưa có thông báo nào</span>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                            ...
                            {/* Tham gia nhóm PC (Ẩn trên mobile) */}
                            <div className="hidden md:flex items-center gap-2 ml-2">
                                <div className="h-4 w-px bg-zinc-200 mx-2"></div>
                                <a href="https://zalo.me/g/jeflei549" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 bg-zinc-900 text-white rounded-full text-sm font-bold shadow-sm">Tham gia Nhóm</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* HERO SECTION */}
            <section className="pt-28 pb-16 px-6 lg:px-8 max-w-7xl mx-auto min-h-[90vh] flex flex-col justify-center gap-12 lg:flex-row lg:items-center">
                <div className="w-full lg:w-1/2 animate-in slide-in-from-left-8 duration-700">
                    ...
                    <h1 className="text-4xl md:text-[4rem] font-bold tracking-tight leading-[1.1] mb-6 text-zinc-900">
                        Nơi nào có ý chí <br />
                        <span className="text-zinc-400 font-light italic font-serif text-3xl md:text-[3.5rem]">nơi đó có con đường</span>
                    </h1>
                    <div className="flex flex-wrap gap-3">
                        <button onClick={scrollToFeatures} className="px-7 py-3.5 bg-zinc-900 text-white rounded-full text-sm font-bold hover:scale-105 transition-all flex items-center gap-2">
                            Bắt đầu học
                            <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path d="m9 18 6-6-6-6"></path></svg>
                        </button>
                    </div>
                </div>
            ...
            {/* FEATURES SECTION */}
            <section ref={featuresRef} className="py-20 bg-zinc-50/50 border-t border-zinc-100 min-h-screen">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-16 px-4">
                        <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4">HÔM NAY BẠN MUỐN HỌC GÌ?</h2>
                        <p className="text-zinc-500 text-sm md:text-lg">Phương pháp học Flashcard, lặp lại ngắt quãng...</p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-6">
                        <div onClick={() => onOpenSetup('game')} className="group bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm active:scale-95 transition-all cursor-pointer">
                            <div className="w-12 h-12 bg-zinc-50 rounded-xl flex items-center justify-center mb-6 text-zinc-900 group-hover:bg-zinc-900 group-hover:text-white transition-colors">
                                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 18V5"/><path d="M15 13a4.17 4.17 0 0 1-3-4 4.17 4.17 0 0 1-3 4"/><path d="M17.598 6.5A3 3 0 1 0 12 5a3 3 0 1 0-5.598 1.5"/><path d="M17.997 5.125a4 4 0 0 1 2.526 5.77"/><path d="M18 18a4 4 0 0 0 2-7.464"/><path d="M19.967 17.483A4 4 0 1 1 12 18a4 4 0 1 1-7.967-.517"/><path d="M6 18a4 4 0 0 1-2-7.464"/><path d="M6.003 5.125a4 4 0 0 0-2.526 5.77"/></svg>
                            </div>
                            <h3 className="text-xl font-bold mb-1 uppercase">Chế độ học</h3>
                            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest">Trắc nghiệm kiến thức</p>
                        </div>
                        
                        <div onClick={() => onOpenSetup('flashcard')} className="group bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm active:scale-95 transition-all cursor-pointer">
                            <div className="w-12 h-12 bg-zinc-50 rounded-xl flex items-center justify-center mb-6 text-zinc-900 group-hover:bg-zinc-900 group-hover:text-white transition-colors">
                                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/></svg>
                            </div>
                            <h3 className="text-xl font-bold mb-1 uppercase">Flashcard</h3>
                            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest">Ghi nhớ ngắt quãng</p>
                        </div>

                        <div onClick={() => onOpenSetup('essay')} className="group bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm active:scale-95 transition-all cursor-pointer">
                            <div className="w-12 h-12 bg-zinc-50 rounded-xl flex items-center justify-center mb-6 text-zinc-900 group-hover:bg-zinc-900 group-hover:text-white transition-colors">
                                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>
                            </div>
                            <h3 className="text-xl font-bold mb-1 uppercase">Tự luận</h3>
                            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest">Gõ đáp án chính xác</p>
                        </div>

                        <div onClick={onOpenReviewList} className="group bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm active:scale-95 transition-all cursor-pointer relative overflow-hidden">
                            {dueCharsCount > 0 && <div className="absolute top-4 right-4 bg-red-500 text-white text-[10px] font-black px-3 py-1.5 rounded-full animate-pulse uppercase z-10 shadow-md">Cần ôn</div>}
                            <div className="w-12 h-12 bg-zinc-50 rounded-xl flex items-center justify-center mb-6 text-zinc-900 group-hover:bg-zinc-900 group-hover:text-white transition-colors">
                                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>
                            </div>
                            <h3 className="text-xl font-bold mb-1 uppercase">Lịch trình</h3>
                            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest">Quản lý việc học</p>
                        </div>
                    </div>

                    {/* VÙNG NÚT BỔ SUNG CHO MOBILE (TÀI LIỆU + NHÓM) */}
                    <div className="mt-12 flex flex-col gap-4 md:hidden px-4">
                        <button onClick={() => setIsDocsModalOpen(true)} className="w-full py-4 bg-zinc-100 text-zinc-900 font-bold rounded-2xl flex items-center justify-center gap-2 border border-zinc-200">
                        ...
                        <a href="https://zalo.me/g/jeflei549" target="_blank" rel="noopener noreferrer" className="w-full py-4 bg-zinc-900 text-white font-bold rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-zinc-200">
            ...
            <footer className="bg-white border-t border-zinc-100 py-12 relative z-10">
                <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <p className="text-xs text-zinc-400">© 2026 Phá Đảo Tiếng Nhật.</p>
                </div>
            </footer>

            {/* POPUP TÀI LIỆU */}
            {isDocsModalOpen && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in" onClick={() => setIsDocsModalOpen(false)}>
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden flex flex-col max-h-[85vh]" onClick={e => e.stopPropagation()}>
                        <div className="p-4 border-b flex justify-between items-center bg-gray-50">
                            <h3 className="text-sm font-bold text-gray-700 flex items-center gap-2">
                                <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="text-indigo-600"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
                                TÀI LIỆU HỌC TẬP
                            </h3>
                            <button onClick={() => setIsDocsModalOpen(false)} className="p-2 hover:bg-gray-100 rounded-full">✕</button>
                        </div>
                        <div className="p-4 space-y-3 overflow-y-auto custom-scrollbar">
                            {/* Copy nguyên list thẻ tài liệu của bạn vào đây */}
                            <a href="https://drive.google.com/drive/folders/19JT79eX8-xn6jweibSj8vzxnugJwjI4C" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-purple-50 transition-all">
                                <div className="w-10 h-10 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center flex-shrink-0"><svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><path d="M14 2v6h6"/></svg></div>
                                <div className="flex-1 min-w-0"><p className="text-sm font-bold truncate">Sách luyện đề JLPT (N5-N1)</p><p className="text-[10px] text-gray-400">15 quyển</p></div>
                            </a>
                            {/* Thêm tiếp các link khác tương tự... */}
                            <a href="https://drive.google.com/file/d/1Q3bbd3Aao7R71wemjESHddbvmXWYe542/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-purple-50 transition-all">
                                <div className="w-10 h-10 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center flex-shrink-0"><svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><path d="M14 2v6h6"/></svg></div>
                                <div className="flex-1 min-w-0"><p className="text-sm font-bold truncate">2139 Hán tự (N5-N1)</p><p className="text-[10px] text-gray-400">PDF • 797 KB</p></div>
                            </a>
                            <a href="https://drive.google.com/file/d/17L2ufF9P0GfLrhzE_yCsAqjXYSYrhTxU/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-purple-50 transition-all">
                                <div className="w-10 h-10 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center flex-shrink-0"><svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><path d="M14 2v6h6"/></svg></div>
                                <div className="flex-1 min-w-0"><p className="text-sm font-bold truncate">Quy tắc chuyển âm</p><p className="text-[10px] text-gray-400">PDF • 128 KB</p></div>
                            </a>
                        </div>
                        <div className="p-4 bg-white">
                            <button onClick={() => setIsDocsModalOpen(false)} className="w-full py-3 bg-zinc-900 text-white font-bold rounded-xl shadow-lg active:scale-95 transition-all uppercase text-xs">ĐÓNG</button>
                        </div>
                    </div>
                </div>
            )}
